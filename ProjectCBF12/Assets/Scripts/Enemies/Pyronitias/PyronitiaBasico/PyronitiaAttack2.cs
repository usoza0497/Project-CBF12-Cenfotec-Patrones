...
public class PyronitiaAttack2 : StateMachineBehaviour
{
    private Transform player;
    private Transform attack;
    public float attackRadio;
    private float desiredNormalizedTime = 0.4f;  // El tiempo normalizado en el que deseas que se active el if
